...
void Readparameters::addDefaultParameters() {
   ...
   if (rank == MASTER_RANK) {
      ...
      descriptions->add_options()("global_config", PO::value<string>(&global_config_file_name)->default_value(""),
          ...
          "variables "
          "(prefixed with MAIN_) and the command line")("run_config", PO::value<string>(&run_config_file_name)->default_value(""),
