...
namespace projects {
   ...
   void Magnetosphere::setProjectBField(FsGrid<std::array<Real, fsgrids::bfield::N_BFIELD>, FS_STENCIL_WIDTH>& perBGrid, FsGrid<std::array<Real, fsgrids::bgbfield::N_BGB>, FS_STENCIL_WIDTH>& BgBGrid,
      ...
      case 4: // Vector potential dipole, vanishes or optionally scales to static inflow value after a given x-coordinate
         ...
         bgVectorDipole.initialize(8e15 * this->dipoleScalingFactor, 0.0, 0.0, 0.0, this->dipoleTiltPhi * M_PI / 180., this->dipoleTiltTheta * M_PI / 180., this->dipoleXFull, this->dipoleXZero,
