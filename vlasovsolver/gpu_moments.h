...
// Compute parameters
   ...
   while (!allSpatialCellTimeLoopsComplete) { // Substep loop
      ...
      getCellIndexArray_kernel<<<blocksPerGrid_getCellIndexArray, totalThreadsPerBlock_getCellIndexArray>>>(dev_cellIdxArray, dev_velocityIdxArray, dev_cellIdxStartCutoff,
                                                                                                            numberOfComputedVelocityBlocks, maxCellIndex);
      ...
      build2dArrayOfFvmu_kernel<<<blocksPerGrid_build2dArrayOfFvmu, threadsPerBlock_build2dArrayOfFvmu>>>(dev_cellIdxArray, dev_velocityIdxArray, dev_VBCs, dev_bulkVX, dev_bulkVY, dev_bulkVZ,
                                                                                                          dev_bValues, dev_fmu, dev_fcount, dVbins, dmubins, nbins_v, nbins_mu);
      ...
      computeDerivativesCFLDdt_kernel<<<blocksPerGrid_computeDerivativesCFLDdt, totalThreadsPerBlock_computeDerivativesCFLDdt, sharedMemorySize>>>(
          dev_smallCellIdxArray, dev_fcount, dev_fmu, dev_nu0Values, dev_dfdt_mu, dev_cellIdxKeys, dev_potentialDdtValues, dev_sparsity, dVbins, dmubins, epsilon, Parameters::PADCFL, nbins_v,
          nbins_mu, blocksPerSpatialCell, lastBlockSize);
      ...
      reduceDdtValues_kernel<<<blocksPerGrid_reduceDdtValues, totalThreadsPerBlock_reduceDdtValues, sharedMemorySize_reduceDdtValues>>>(dev_cellIdxKeys, dev_potentialDdtValues, dev_Ddt,
