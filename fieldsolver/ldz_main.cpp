...
bool propagateFields(FsGrid<std::array<Real, fsgrids::bfield::N_BFIELD>, FS_STENCIL_WIDTH>& perBGrid, FsGrid<std::array<Real, fsgrids::bfield::N_BFIELD>, FS_STENCIL_WIDTH>& perBDt2Grid,
   ...
   if (subcycles == 1) {
      ...
      if (P::ohmHallTerm > 0) {
         calculateHallTermSimple(perBGrid, perBDt2Grid, EHallGrid, momentsGrid, momentsDt2Grid, dPerBGrid, dMomentsGrid, dMomentsDt2Grid, BgBGrid, technicalGrid, sysBoundaries, RK_ORDER1,
                                 true // communicateMomentsDerivatives
         );
      }
      calculateUpwindedElectricFieldSimple(perBGrid, perBDt2Grid, EGrid, EDt2Grid, EHallGrid, EGradPeGrid, EGradPeDt2Grid, momentsGrid, momentsDt2Grid, dPerBGrid, dMomentsGrid, dMomentsDt2Grid,
      ...
      if (P::ohmHallTerm > 0) {
         calculateHallTermSimple(perBGrid, perBDt2Grid, EHallGrid, momentsGrid, momentsDt2Grid, dPerBGrid, dMomentsGrid, dMomentsDt2Grid, BgBGrid, technicalGrid, sysBoundaries, RK_ORDER2_STEP1,
                                 true // communicateMomentsDerivatives
         );
      }
      calculateUpwindedElectricFieldSimple(perBGrid, perBDt2Grid, EGrid, EDt2Grid, EHallGrid, EGradPeGrid, EGradPeDt2Grid, momentsGrid, momentsDt2Grid, dPerBGrid, dMomentsGrid, dMomentsDt2Grid,
      ...
      if (P::ohmHallTerm > 0) {
         calculateHallTermSimple(perBGrid, perBDt2Grid, EHallGrid, momentsGrid, momentsDt2Grid, dPerBGrid, dMomentsGrid, dMomentsDt2Grid, BgBGrid, technicalGrid, sysBoundaries, RK_ORDER2_STEP2,
                                 true // communicateMomentsDerivatives
         );
      }
      calculateUpwindedElectricFieldSimple(perBGrid, perBDt2Grid, EGrid, EDt2Grid, EHallGrid, EGradPeGrid, EGradPeDt2Grid, momentsGrid, momentsDt2Grid, dPerBGrid, dMomentsGrid, dMomentsDt2Grid,
      ...
      while (subcycleCount < maxSubcycleCount) {
         ...
         calculateDerivativesSimple(perBGrid, perBDt2Grid, momentsGrid, momentsDt2Grid, dPerBGrid, dMomentsGrid, dMomentsDt2Grid, technicalGrid, sysBoundaries, RK_ORDER2_STEP1,
         ...
         // We need to calculate derivatives of the moments at every substep, but the moments only
         // need to be communicated in the first one.
         calculateDerivativesSimple(perBGrid, perBDt2Grid, momentsGrid, momentsDt2Grid, dPerBGrid, dMomentsGrid, dMomentsDt2Grid, technicalGrid, sysBoundaries, RK_ORDER2_STEP2,
                                    (subcycleCount == 0) /*doMoments*/);
         if (P::ohmGradPeTerm > 0 && subcycleCount == 0) {
            calculateGradPeTermSimple(EGradPeGrid, EGradPeDt2Grid, momentsGrid, momentsDt2Grid, dMomentsGrid, dMomentsDt2Grid, technicalGrid, sysBoundaries, RK_ORDER2_STEP2);
         }
